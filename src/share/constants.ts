export const SITE_NAVER = 'naver'
export const SITE_ASIL = 'asil'
...
export const NAVER_MESSAGE_REQUEST_APP_TOKEN = 'request:token'
export const NAVER_MESSAGE_SHARE_APP_TOKEN = 'share:token'
